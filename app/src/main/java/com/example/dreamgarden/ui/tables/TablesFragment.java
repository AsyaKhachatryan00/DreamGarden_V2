...
import com.example.dreamgarden.Adapter.TableAdapter;
...
public class TablesFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.tables_fragment, container, false);
        ...
        mViewModel.getMutableLiveData().observe(getViewLifecycleOwner(), tables -> {
